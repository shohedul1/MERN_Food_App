            ...
            <body>
              <div class="email-container">
                <div class="email-header">
                  <h1>Welcome to shohidul Food!</h1>
                </div>
                <div class="email-body">
                  ...
                  <p>Best Regards,<br/>The shohidul Food Team</p>
                </div>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The shohidul Food Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2024 Patel Food. All rights reserved.</p>
            </div>
      ...
      <html>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-footer">
              <p>&copy; 2024 shohidul Food. All rights reserved.</p>
            </div>
          </div>
        </body>
      </html>
